...
$publickey = "6Lc4neISAAAAAAluh0xNgkNiTWs9dRuo62XsmbAZ";
$privatekey = "6Lc4neISAAAAAKkQjxSzMvFOz9sqIH43kALQHUVQ";
...
#EDIT THE FOLLOWING:
$toAddress = "info@uwaver.com";  //place your/your client's email address here - EDISON/ZEPHIR WILL ONLY EMAIL seattlecentral.edu ADDRESSES!
$toName = "uWaver"; //place your client's name here
$website = "uWaver Ltd.";  //place NAME of your client's website here
...
<script type="text/javascript">
	...
	var RecaptchaOptions = { theme : "clean"}; //reCAPTCHA color themes: https://developers.google.com/recaptcha/docs/customization
</script>
...
?>
		...
		<div class="contact-feedback">
			<h1>Thank you! Your Comments Have Been Received!</h1>
	        <h2 class="feedback">We will get in touch with you shortly!</h2>
	    </div>    
	...
	<table class="contact-table">
		<tr><!-- the form elements 'Name' and 'Email' are sigificant to the app, any others can be added/deleted -->
			<td>
				...
				<input class="info" type="text" name="Name" required="required" />
			</td>
		</tr>
		<tr>
			<td>
				<span class="required">* </span>Email:<br />
				<input class="info" type="email" name="Email" required="required" />
			</td>
		</tr>
		<tr>
			<td>
